...
export default function RecordsSection() {
  const {records, openClearAllModal, openManualAddModal} = useTimerStore();
      ...
      <div className='flex justify-between items-center mb-6'>
        ...
        <div className='flex gap-2'>
          <button
            ...
            className='bg-green-600 text-white text-sm px-4 py-2 rounded-lg min-w-0 border-none cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:bg-green-700'
            title='수동으로 시간 추가'>
            ➕ 수동 추가
          </button>
          <button
